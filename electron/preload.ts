...
interface ElectronAPI {
  ...
  testLlmConnection: (provider: 'gemini' | 'groq' | 'openai' | 'claude' | 'moonshot', apiKey?: string) => Promise<{ success: boolean; error?: string }>
  ...
  setMoonshotApiKey: (apiKey: string) => Promise<{ success: boolean; error?: string }>
  getStoredCredentials: () => Promise<{ hasGeminiKey: boolean; hasGroqKey: boolean; hasOpenaiKey: boolean; hasClaudeKey: boolean; hasMoonshotKey: boolean; googleServiceAccountPath: string | null; sttProvider: string; hasSttGroqKey: boolean; hasSttOpenaiKey: boolean; hasDeepgramKey: boolean; hasElevenLabsKey: boolean; hasAzureKey: boolean; azureRegion: string; hasIbmWatsonKey: boolean; ibmWatsonRegion: string; hasSonioxKey: boolean; sonioxSttModel?: string; moonshotPreferredModel?: string }>
  ...
  setSonioxSttModel: (model: string) => Promise<{ success: boolean; error?: string }>
  fetchSonioxSttModels: (apiKey?: string) => Promise<{ success: boolean; models?: { id: string; label: string }[]; error?: string }>
  testSttConnection: (provider: 'groq' | 'openai' | 'deepgram' | 'elevenlabs' | 'azure' | 'ibmwatson' | 'soniox', apiKey: string, region?: string, model?: string) => Promise<{ success: boolean; error?: string }>
...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  testLlmConnection: (provider: 'gemini' | 'groq' | 'openai' | 'claude' | 'moonshot', apiKey: string) => ipcRenderer.invoke("test-llm-connection", provider, apiKey),
  ...
  setMoonshotApiKey: (apiKey: string) => ipcRenderer.invoke("set-moonshot-api-key", apiKey),
  ...
  setSonioxSttModel: (model: string) => ipcRenderer.invoke("set-soniox-stt-model", model),
  fetchSonioxSttModels: (apiKey?: string) => ipcRenderer.invoke("fetch-soniox-stt-models", apiKey),
  testSttConnection: (provider: 'groq' | 'openai' | 'deepgram' | 'elevenlabs' | 'azure' | 'ibmwatson' | 'soniox', apiKey: string, region?: string, model?: string) => ipcRenderer.invoke("test-stt-connection", provider, apiKey, region, model),
  ...
  fetchProviderModels: (provider: 'gemini' | 'groq' | 'openai' | 'claude' | 'moonshot', apiKey: string) => ipcRenderer.invoke('fetch-provider-models', provider, apiKey),
  setProviderPreferredModel: (provider: 'gemini' | 'groq' | 'openai' | 'claude' | 'moonshot', modelId: string) => ipcRenderer.invoke('set-provider-preferred-model', provider, modelId),
