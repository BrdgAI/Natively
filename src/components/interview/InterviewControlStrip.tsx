  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {mousePassthrough ? (
          <div className="text-[11px] font-medium text-[#665950]">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="rounded-[8px] border border-[#cfc4ba] bg-[rgba(255,252,248,0.64)] px-2.5 py-1 text-[11px] font-semibold text-[#201915]">
